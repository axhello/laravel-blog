    ...
    <div class="panel-main">
        <div class="panel-main__inner panel-inverted">
            <div class="panel-main__content">
                ...
                <h1 class="panel-cover__title panel-title"><a href="/" title="Ciyuan'ai的主页" class="blog-button">Ciyuan'ai</a>
                </h1>
                        ...
                        <nav class="cover-navigation cover-navigation--primary">
                            <ul class="navigation">
                                ...
                                @foreach($pages as $page)
                                    <li class="navigation__item"><a href="/pages/{{ $page->slug }}" title="{{ $page->title }}">{{ $page->title }}</a>
                                    </li>
                                @endforeach
